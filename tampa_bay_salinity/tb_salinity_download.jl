...
println("Attempting to download all available TBOFS files for $num_days days...")
...
for date in dates
    ...
    for cycle in cycles
        ...
        catalog_url = "https://opendap.co-ops.nos.noaa.gov/thredds/catalog/NOAA/TBOFS/MODELS/$yyyy/$mm/$dd/catalog.html"
        ...
        try
            ...
            # Match: TBOFS.t18z.20260216.fields.n001.nc
            pat = Regex("TBOFS\\.t$(cycle)z\\.$yyyymmdd\\.fields\\.n(\\d{3})\\.nc")
        ...
        for f_hour in f_hours
            thredds_url = "https://opendap.co-ops.nos.noaa.gov/thredds/fileServer/NOAA/TBOFS/MODELS/$yyyy/$mm/$dd/TBOFS.t$(cycle)z.$yyyymmdd.fields.n$f_hour.nc"
            local_file = "$destination_dir/tampa_salinity_$(yyyymmdd)_t$(cycle)z_n$(f_hour).nc"
